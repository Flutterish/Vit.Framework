...
public struct Point1<T> : IInterpolatable<Point1<T>, T>, IEqualityOperators<Point1<T>, Point1<T>, bool>, IEquatable<Point1<T>> where T : INumber<T> {
	public T X;
	...
	public static implicit operator Span<T> ( Point1<T> value )
		=> value.AsSpan();
	public static implicit operator ReadOnlySpan<T> ( Point1<T> value )
