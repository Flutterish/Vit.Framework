...
public class OpenTypeFont : Font {
	...
	public OpenTypeFont ( OpenFontFile data ) {
		...
		if ( tablesByTag.TryGetValue( "CFF ", out var maybeCff ) && maybeCff is CffTable cff ) {
		...
		else if ( tablesByTag.TryGetValue( "glyf", out var maybeGlyf ) && maybeGlyf is GlyphDataTable glyf ) {
