...
public struct StringId {
	public byte A;
	public byte B;
	public ushort Value => (ushort)( A << 8 | B );
	...
	public static implicit operator StringId ( int id )
		=> new( (ushort)id );

	public override string ToString () {
		if ( StandardStrings.TryGetValue( this, out var std ) )
			return $"Standard String ID {Value} \"{std}\"";
		return $"String ID {Value}";
	}

	public static readonly Dictionary<StringId, string> StandardStrings = new() {
